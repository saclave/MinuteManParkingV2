...
insert into parking_lot(ID,LONGITUDE,LATITUDE,NAME,ADDRESS, CITY, PRICE, IMG_SRC) values (11,121.032714,14.508469, 'Balagbag Wet & Dry Market', 'Balagbag Wet & Dry Market, Merville Access Road, Parañaque, Metro Manila', 'Parañaque', 20, 'https://upload.wikimedia.org/wikipedia/commons/1/13/CSFLU_Dry_Market_%28San_Fernando%2C_La_Union%29%282018-11-25%29.jpg');
...
insert into parking_slot(ID,AVAILABILITY,NAME,PARKING_LOT_ID) values (31,false,'A1',6);
insert into parking_slot(ID,AVAILABILITY,NAME,PARKING_LOT_ID) values (32,false,'B1',7);
insert into parking_slot(ID,AVAILABILITY,NAME,PARKING_LOT_ID) values (33,true,'A1',8);
insert into parking_slot(ID,AVAILABILITY,NAME,PARKING_LOT_ID) values (34,true,'A2',8);
insert into parking_slot(ID,AVAILABILITY,NAME,PARKING_LOT_ID) values (35,true,'A3',8);
insert into parking_slot(ID,AVAILABILITY,NAME,PARKING_LOT_ID) values (36,true,'A4',8);
insert into parking_slot(ID,AVAILABILITY,NAME,PARKING_LOT_ID) values (37,true,'B1',9);
insert into parking_slot(ID,AVAILABILITY,NAME,PARKING_LOT_ID) values (38,true,'B2',9);
insert into parking_slot(ID,AVAILABILITY,NAME,PARKING_LOT_ID) values (39,true,'B3',9);
insert into parking_slot(ID,AVAILABILITY,NAME,PARKING_LOT_ID) values (40,true,'B4',9);
insert into parking_slot(ID,AVAILABILITY,NAME,PARKING_LOT_ID) values (41,true,'C1',10);
insert into parking_slot(ID,AVAILABILITY,NAME,PARKING_LOT_ID) values (42,true,'C2',10);
insert into parking_slot(ID,AVAILABILITY,NAME,PARKING_LOT_ID) values (43,true,'C3',10);
insert into parking_slot(ID,AVAILABILITY,NAME,PARKING_LOT_ID) values (44,true,'C4',10);
insert into parking_slot(ID,AVAILABILITY,NAME,PARKING_LOT_ID) values (45,true,'D1',11);
insert into parking_slot(ID,AVAILABILITY,NAME,PARKING_LOT_ID) values (46,true,'D2',11);
insert into parking_slot(ID,AVAILABILITY,NAME,PARKING_LOT_ID) values (47,true,'E1',12);
insert into parking_slot(ID,AVAILABILITY,NAME,PARKING_LOT_ID) values (48,true,'E2',12);
insert into parking_slot(ID,AVAILABILITY,NAME,PARKING_LOT_ID) values (49,true,'E3',12);
insert into parking_slot(ID,AVAILABILITY,NAME,PARKING_LOT_ID) values (50,true,'E4',12);


insert into hazard(ID, TYPE, LONGITUDE, LATITUDE, ADDRESS, NAME) values (1, 'TRAFFIC', 120.9884, 14.5329, 'Pasay', 'TRAFFIC AREA');
insert into hazard(ID, TYPE, LONGITUDE, LATITUDE, ADDRESS, NAME) values (2, 'STOP', 120.9886, 14.5317, 'Pasay', 'STOP ZONE');
insert into hazard(ID, TYPE, LONGITUDE, LATITUDE, ADDRESS, NAME) values (3, 'TOWAWAY', 120.9848, 14.5354, 'Pasay', 'TOWAWAY ZONE');
insert into hazard(ID, TYPE, LONGITUDE, LATITUDE, ADDRESS, NAME) values (4, 'TOWAWAY', 120.9843, 14.5373, 'Pasay', 'TOWAWAY ZONE');
insert into hazard(ID, TYPE, LONGITUDE, LATITUDE, ADDRESS, NAME) values (5, 'ROUNDABOUT', 120.9843, 14.5332, 'Pasay', 'ROUNDABOUT ZONE');

insert into hazard(ID, TYPE, LONGITUDE, LATITUDE, ADDRESS, NAME) values (6, 'PARKING', 120.9855, 14.5311, 'Pasay', 'PARKING AREA');
insert into hazard(ID, TYPE, LONGITUDE, LATITUDE, ADDRESS, NAME) values (7, 'PARKING', 120.9863, 14.5311, 'Pasay', 'PARKING AREA');

insert into hazard(ID, TYPE, LONGITUDE, LATITUDE, ADDRESS, NAME) values (8, 'NOPARK', 121.0170,14.5030, 'Parañaque', 'NO PARK AREA');
insert into hazard(ID, TYPE, LONGITUDE, LATITUDE, ADDRESS, NAME) values (9, 'OVERTAKE', 121.0238,14.5058, 'Parañaque', 'OVERTAKE ZONE');
insert into hazard(ID, TYPE, LONGITUDE, LATITUDE, ADDRESS, NAME) values (10, 'TOWAWAY',121.0171, 14.5026, 'Parañaque', 'TOWAWAY ZONE');
insert into hazard(ID, TYPE, LONGITUDE, LATITUDE, ADDRESS, NAME) values (11, 'NORIGHT', 121.0189, 14.4998, 'Parañaque', 'NO RIGHT ZONE');
insert into hazard(ID, TYPE, LONGITUDE, LATITUDE, ADDRESS, NAME) values (12, 'TOWAWAY', 121.0234, 14.4999, 'Parañaque', 'TOWAWAY ZONE');

insert into hazard(ID, TYPE, LONGITUDE, LATITUDE, ADDRESS, NAME) values (13, 'PARKING', 121.0349, 14.4938, 'Parañaque', 'PARKING AREA');
insert into hazard(ID, TYPE, LONGITUDE, LATITUDE, ADDRESS, NAME) values (14, 'PARKING', 121.0375, 14.4887, 'Parañaque', 'PARKING AREA');
