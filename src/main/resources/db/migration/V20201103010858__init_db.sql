...
create table parking_lot (id integer generated by default as identity, name varchar(255) not null, address varchar(255), latitude double, longitude double, price double, img_src varchar(1000), primary key (id));
